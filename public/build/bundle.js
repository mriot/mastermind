    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(/*label*/ ctx[0]);
    			attr_dev(button, "class", "svelte-ifdfdt");
    			add_location(button, file$3, 25, 0, 483);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$2, 12, 2, 145);
    			add_location(section, file$2, 19, 2, 311);
    			attr_dev(div, "id", "gameboard");
    			attr_dev(div, "class", "svelte-ojx27d");
    			add_location(div, file$2, 11, 0, 122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(pre, "class", "svelte-1vjl5ou");
    			add_location(pre, file$1, 25, 2, 340);
    			attr_dev(header, "class", "svelte-1vjl5ou");
    			add_location(header, file$1, 24, 0, 329);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
